...
def two_level_clustering(num_coarse_clusters: int, num_total_clusters: int, save_path: str, name: str, 
...
def train_ivf_index_with_two_level_clustering(index: faiss.IndexPreTransform, num_total_clusters: int,max_memory_usage: int, vector_dimension: int, save_path: str, name: str) -> faiss.IndexPreTransform:
    """
    ...
    centroids = two_level_clustering(
        num_coarse_clusters, num_total_clusters, save_path, name, all_vector_transforms, max_memory_usage, vector_dimension)
